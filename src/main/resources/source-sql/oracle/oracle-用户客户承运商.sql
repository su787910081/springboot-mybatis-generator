...
DECLARE
      num   NUMBER;
BEGIN
    SELECT COUNT(1) INTO num FROM user_tables WHERE TABLE_NAME = upper('crm_customer_info') ;
    IF num > 0 THEN
        EXECUTE IMMEDIATE 'DROP TABLE crm_customer_info' ;
    END IF;
END;
...
COMMENT ON COLUMN crm_customer_info.created_by IS '创建者';
COMMENT ON COLUMN crm_customer_info.created_time IS '创建时间';
COMMENT ON COLUMN crm_customer_info.updated_by IS '修改者';
COMMENT ON COLUMN crm_customer_info.updated_time IS '修改时间';
-- 添加列
...
DECLARE
    num   NUMBER;
BEGIN
    SELECT COUNT(1) INTO num FROM user_tables WHERE TABLE_NAME = upper('crm_settle_money_info') ;
    IF num > 0 THEN
        EXECUTE IMMEDIATE 'DROP TABLE crm_settle_money_info' ;
    END IF;
END;
...
COMMENT ON COLUMN crm_settle_money_info.created_by IS '创建者';
COMMENT ON COLUMN crm_settle_money_info.created_time IS '创建时间';
COMMENT ON COLUMN crm_settle_money_info.updated_by IS '修改者';
COMMENT ON COLUMN crm_settle_money_info.updated_time IS '修改时间';
-- 添加列
...
DECLARE
    num   NUMBER;
BEGIN
    SELECT COUNT(1) INTO num FROM user_tables WHERE TABLE_NAME = upper('crm_contacts_info') ;
    IF num > 0 THEN
        EXECUTE IMMEDIATE 'DROP TABLE crm_contacts_info' ;
    END IF;
END;
...
COMMENT ON COLUMN crm_contacts_info.created_by IS '创建者';
COMMENT ON COLUMN crm_contacts_info.created_time IS '创建时间';
COMMENT ON COLUMN crm_contacts_info.updated_by IS '修改者';
COMMENT ON COLUMN crm_contacts_info.updated_time IS '修改时间';
-- 添加列
...
DECLARE
    num   NUMBER;
BEGIN
    SELECT COUNT(1) INTO num FROM user_tables WHERE TABLE_NAME = upper('crm_invoice_info') ;
    IF num > 0 THEN
        EXECUTE IMMEDIATE 'DROP TABLE crm_invoice_info' ;
    END IF;
END;
...
COMMENT ON COLUMN crm_invoice_info.created_by IS '创建者';
COMMENT ON COLUMN crm_invoice_info.created_time IS '创建时间';
COMMENT ON COLUMN crm_invoice_info.updated_by IS '修改者';
COMMENT ON COLUMN crm_invoice_info.updated_time IS '修改时间';
-- 添加列
...
DECLARE
    num   NUMBER;
BEGIN
    SELECT COUNT(1) INTO num FROM user_tables WHERE TABLE_NAME = upper('crm_payee_info') ;
    IF num > 0 THEN
        EXECUTE IMMEDIATE 'DROP TABLE crm_payee_info' ;
    END IF;
END;
...
COMMENT ON COLUMN crm_payee_info.created_by IS '创建者';
COMMENT ON COLUMN crm_payee_info.created_time IS '创建时间';
COMMENT ON COLUMN crm_payee_info.updated_by IS '修改者';
COMMENT ON COLUMN crm_payee_info.updated_time IS '修改时间';
-- 添加列
